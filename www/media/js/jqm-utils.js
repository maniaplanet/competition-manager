$(document).bind('pageinit', function() {
	...
	$.mobile.popup.prototype._oldPlacementCoords = $.mobile.popup.prototype._placementCoords;
	$.mobile.popup.prototype._placementCoords = function(desired) {
		var ret = this._oldPlacementCoords(desired);
		return {left: Math.round(ret.left), top: Math.round(ret.top)};
	}
});
