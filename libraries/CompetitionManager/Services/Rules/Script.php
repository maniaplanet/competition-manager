...
abstract class Script extends \CompetitionManager\Services\Rules
{
	public $gameMode = GameInfos::GAMEMODE_SCRIPT;
	public $name;
	
	function getIcon()
	{
		return array(Icon::Icons128x32_1, Icons128x32_1::RT_Script);
	}
}
